...
Previously, I've [written up on database diagramming](2015-12-09-documenting-your-database-with-diagrams.md)for visualization of database structures. Check that out for more detailed review on what I've used.
